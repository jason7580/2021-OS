...
// while executing kernel code.
  ...
  public:
    ...
    double predict; // approximate burst time
    int burst; // the time that thread during running state
    int start; // time when thread start in running state
    int enqueue; // time when thread enters the ready queue
    int aging; // the last time when thread was done aging
    double cmptime; // the time which is used to compare in L1 
    bool preempted; // whether the thread will be preemted
